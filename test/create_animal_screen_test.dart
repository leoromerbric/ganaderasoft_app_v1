...
void main() {
  group('Create Animal Screen Tests', () {
    ...
    testWidgets('Procedencia field should be a text input field', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: CreateAnimalScreen(
            finca: testFinca,
            rebanos: testRebanos,
          ),
        ),
    ...
    testWidgets('Procedencia field validation works correctly', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: CreateAnimalScreen(
            finca: testFinca,
      ...
      final procedenciaField = find.widgetWithText(TextFormField, 'Ingresa la procedencia del animal');
    ...
    testWidgets('Date picker should not have locale parameter', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: CreateAnimalScreen(
            finca: testFinca,
